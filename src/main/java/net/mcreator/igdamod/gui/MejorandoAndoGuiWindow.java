...
@OnlyIn(Dist.CLIENT)
public class MejorandoAndoGuiWindow extends ContainerScreen<MejorandoAndoGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = MejorandoAndoGui.guistate;
	public MejorandoAndoGuiWindow(MejorandoAndoGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("igdamod:textures/mejorando_ando.png");
	@Override
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		this.font.drawString(ms, "Mejorando Ando", 53, 8, -13717215);
	}
