...
package net.mcreator.igdamod.entity;
...
import net.mcreator.igdamod.entity.renderer.DukeRenderer;
import net.mcreator.igdamod.IgdamodModElements;

@IgdamodModElements.ModElement.Tag
public class DukeEntity extends IgdamodModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13421773, -16738048, new Item.Properties().group(IGDAItemGroup.tab))
				.setRegistryName("duke_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 0;
			setNoAI(false);
			setCustomName(new StringTextComponent("Duke"));
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (DukeBoneItem.block == stack.getItem())
				return true;
