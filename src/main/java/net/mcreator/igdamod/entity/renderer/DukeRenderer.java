package net.mcreator.igdamod.entity.renderer;
...
@OnlyIn(Dist.CLIENT)
public class DukeRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(DukeEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelwatanodog(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("igdamod:textures/image_5.png");
					}
				};
			});
		}
