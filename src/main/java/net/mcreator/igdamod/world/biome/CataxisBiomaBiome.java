...
import net.mcreator.igdamod.block.CataxisLogBlock;
import net.mcreator.igdamod.block.CataxisLeavesBlock;
...
public class CataxisBiomaBiome extends IgdamodModElements.ModElement {
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-993079).setWaterColor(-1125846850).setWaterFogColor(-1125846850)
						.withSkyColor(-993079).withFoliageColor(-3328488).withGrassColor(-3189205).build();
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(CataxisLogBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(CataxisLeavesBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("igdamod:cataxis_bioma"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("cataxis_bioma_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("cataxis_bioma_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("cataxis_bioma_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
