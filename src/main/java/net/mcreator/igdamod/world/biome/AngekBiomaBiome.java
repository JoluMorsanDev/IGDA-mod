...
import net.mcreator.igdamod.block.AngekLogBlock;
import net.mcreator.igdamod.block.AngekLeavesBlock;
...
public class AngekBiomaBiome extends IgdamodModElements.ModElement {
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-9188373).setWaterColor(-1134052643).setWaterFogColor(-1135833393)
						.withSkyColor(-9188373).withFoliageColor(-15904354).withGrassColor(-12218645).build();
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(AngekLogBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(AngekLeavesBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("igdamod:angek_bioma"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("angek_bioma_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("angek_bioma_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("angek_bioma_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
