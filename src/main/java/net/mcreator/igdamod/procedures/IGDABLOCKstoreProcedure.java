...
public class IGDABLOCKstoreProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				IgdamodMod.LOGGER.warn("Failed to load dependency entity for procedure IGDABLOCKstore!");
			return;
		}
		...
		if ((((new Object() {
			...
			if ((((new Object() {
				...
				if (entity instanceof PlayerEntity) {
					ItemStack _setstack = new ItemStack(IGDAblockBlock.block);
