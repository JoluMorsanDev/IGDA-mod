...
public class GameCartridge5Item extends IgdamodModElements.ModElement {
	@ObjectHolder("igdamod:game_cartridge_5")
	public static final Item block = null;
	public GameCartridge5Item(IgdamodModElements instance) {
		super(instance, 46);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("game_cartridge_5");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("This is not a pong"));
		}
	}
}
