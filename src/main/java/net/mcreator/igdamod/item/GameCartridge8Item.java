...
public class GameCartridge8Item extends IgdamodModElements.ModElement {
	@ObjectHolder("igdamod:game_cartridge_8")
	public static final Item block = null;
	public GameCartridge8Item(IgdamodModElements instance) {
		super(instance, 17);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("game_cartridge_8");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Bunny Jumper"));
		}
	}
}
