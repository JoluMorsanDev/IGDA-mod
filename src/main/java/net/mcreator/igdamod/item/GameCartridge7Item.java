...
public class GameCartridge7Item extends IgdamodModElements.ModElement {
	@ObjectHolder("igdamod:game_cartridge_7")
	public static final Item block = null;
	public GameCartridge7Item(IgdamodModElements instance) {
		super(instance, 44);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("game_cartridge_7");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Baking Gizmo"));
		}
	}
}
