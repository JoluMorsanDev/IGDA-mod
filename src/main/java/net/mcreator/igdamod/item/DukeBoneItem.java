...
public class DukeBoneItem extends IgdamodModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(IGDAItemGroup.tab).maxStackSize(1).rarity(Rarity.UNCOMMON));
			setRegistryName("duke_bone");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Use it in wolfs"));
		}
	}
}
