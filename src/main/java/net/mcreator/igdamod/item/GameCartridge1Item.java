...
public class GameCartridge1Item extends IgdamodModElements.ModElement {
	@ObjectHolder("igdamod:game_cartridge_1")
	public static final Item block = null;
	public GameCartridge1Item(IgdamodModElements instance) {
		super(instance, 48);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("game_cartridge_1");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Rabbit with a trident"));
		}
	}
}
