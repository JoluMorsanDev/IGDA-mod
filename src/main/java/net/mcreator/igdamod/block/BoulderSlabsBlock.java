...
public class BoulderSlabsBlock extends IgdamodModElements.ModElement {
	@ObjectHolder("igdamod:boulder_slabs")
	public static final Block block = null;
	public BoulderSlabsBlock(IgdamodModElements instance) {
		super(instance, 184);
	}
