...
public class AngekBlockBlock extends IgdamodModElements.ModElement {
	@ObjectHolder("igdamod:angek_block")
	public static final Block block = null;
	public AngekBlockBlock(IgdamodModElements instance) {
		super(instance, 165);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5f, 16f).setLightLevel(s -> 2).harvestLevel(1)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().setNeedsPostProcessing((bs, br, bp) -> true)
					.setEmmisiveRendering((bs, br, bp) -> true));
			setRegistryName("angek_block");
		}
