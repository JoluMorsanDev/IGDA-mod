...
public class MarbleBlockBlock extends IgdamodModElements.ModElement {
	@ObjectHolder("igdamod:marble_block")
	public static final Block block = null;
	public MarbleBlockBlock(IgdamodModElements instance) {
		super(instance, 12);
	}
