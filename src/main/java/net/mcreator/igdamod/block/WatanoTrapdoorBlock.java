...
public class WatanoTrapdoorBlock extends IgdamodModElements.ModElement {
	@ObjectHolder("igdamod:watano_trapdoor")
	public static final Block block = null;
	public WatanoTrapdoorBlock(IgdamodModElements instance) {
		super(instance, 180);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("watano_trapdoor");
		}
