...
public class BoulderStairsBlock extends IgdamodModElements.ModElement {
	@ObjectHolder("igdamod:boulder_stairs")
	public static final Block block = null;
	public BoulderStairsBlock(IgdamodModElements instance) {
		super(instance, 183);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("boulder_stairs");
		}
