...
public class BoulderWallBlock extends IgdamodModElements.ModElement {

	@ObjectHolder("igdamod:boulder_wall")
	public static final Block block = null;

	public BoulderWallBlock(IgdamodModElements instance) {
		super(instance, 185);
