...
public class WatanoDoorBlock extends IgdamodModElements.ModElement {
	@ObjectHolder("igdamod:watano_door")
	public static final Block block = null;
	public WatanoDoorBlock(IgdamodModElements instance) {
		super(instance, 179);
	}
