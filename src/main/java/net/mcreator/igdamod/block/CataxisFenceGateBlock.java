...
public class CataxisFenceGateBlock extends IgdamodModElements.ModElement {
	@ObjectHolder("igdamod:cataxis_fence_gate")
	public static final Block block = null;
	public CataxisFenceGateBlock(IgdamodModElements instance) {
		super(instance, 107);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("cataxis_fence_gate");
		}
